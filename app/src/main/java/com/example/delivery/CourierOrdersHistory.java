...
public class CourierOrdersHistory extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        backImageView.setOnClickListener(v -> {
            Intent intent = new Intent(CourierOrdersHistory.this, CourierProfile.class);
    ...
    private void loadCourierOrders() {
        ...
        orderRepository.getOrdersByCourierId(courierId).thenAccept(orders -> {
            orderList.clear();
